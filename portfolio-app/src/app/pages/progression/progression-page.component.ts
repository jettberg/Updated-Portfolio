  ...
  progressionItems = [
    {
      ...
      description:
        'My first portfolio was built with basic HTML and CSS. It was not perfect, but it was the first step in learning how pages are structured, styled, and connected together.',
      image: '/assets/images/projects/profile-headshot.jpg',
